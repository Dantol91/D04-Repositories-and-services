...
public class SponsorServiceTest extends AbstractTest {
	...
	public void createSaveDelete() {
		...
		admin = this.sponsorService.create();
		...
		aSaved = this.sponsorService.save(admin);
		Assert.notNull(aSaved);

		aBefore = this.sponsorService.findAll();
		Assert.isTrue(aBefore.contains(aSaved));

		//Comprobamos delete
		this.sponsorService.delete(aSaved);

		aAfter = this.sponsorService.findAll();
